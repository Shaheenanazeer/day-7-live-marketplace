              ...
              {state.items.length > 0 ? (
                ...
                <div className="grid grid-cols-12 p-6 text-center text-gray-600">
                  <div className="col-span-12">
                    ...
                    <Link href="/shop" className="mt-6 inline-block bg-[#B88E2F] text-white px-6 py-2 rounded-lg hover:bg-[#A47E2F]">
                      Continue Shopping
                    </Link>
                  </div>
                </div>
            ...
            <div className="bg-[#FDF9F0] rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-gray-600">Rs. {state.total.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-base font-medium">Total</span>
                  <span className="text-[#B88E2F] text-xl">Rs. {state.total.toLocaleString()}</span>
                </div>
                {state.items.length > 0 && (
                  <Link href="/checkout">
